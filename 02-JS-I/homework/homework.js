...
function esPositivo(numero) {
  //La función va a recibir un entero. Devuelv o una cadena de texto que indica si el número es positivo o negativo. 
...
function deEuroAdolar(euro){
  ...
  //Escribe tu código aquí
  let calculoDolares= euro * 1.20;
  return calculoDolares;
}
